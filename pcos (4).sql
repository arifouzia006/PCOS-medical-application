...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 06, 2024 at 02:06 PM
...
CREATE TABLE `health_plan` (
  `id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL,
  `meal_plan` enum('yes','no') NOT NULL,
  `meal_percentage` int(11) NOT NULL,
  `exercise_plan` enum('yes','no') NOT NULL,
  `exercise_percentage` int(11) NOT NULL,
  `meditation_routine` enum('yes','no') NOT NULL,
  `meditation_percentage` int(11) NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT current_timestamp(),
  `no_meal` varchar(255) DEFAULT NULL,
  `no_exercise` varchar(255) DEFAULT NULL,
  `no_meditation` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `personal_details` (
  ...
  `centralobesity` varchar(100) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `personal_details` (`id`, `name`, `age`, `Mobile_No`, `height`, `weight`, `bmi`, `otherdisease`, `obstetricscore`, `hip`, `waist`, `hipwaist`, `profile_image`, `centralobesity`) VALUES
(102, 'shobana', 23, '9632587410', 152.00, 55.00, 19.00, 'no', 'unmarried', 28.00, 20.00, 1.20, '1726203558.jpg', 'no');
...
(2, 'shobana', 2, 3, 5, '2024-09-20 07:07:13', '2024-10-04');
...
(82, 'shobana', 'shobana@gmail.com', '12345678', '12345678');
...
(99, 'shobana', '12345678', 'shobana@gmail.com', 'patient', '2024-05-13 07:20:29');
...
--
-- AUTO_INCREMENT for table `health_plan`
--
ALTER TABLE `health_plan`
